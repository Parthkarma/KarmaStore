...
private CategoryRepository categoryRepository ;
 ...
 private  String path;
 @Override
 public ProductDTO addProduct(Long categoryId , ProductDTO productDTO) throws APIException {
...
//product.setImage("default.png");
 ...
 @Override
 public ProductResponse searchByCategory(Long categoryId, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) throws APIException {
  Category category = categoryRepository.findById(categoryId).orElseThrow(() -> new ResourceNotFoundException("Category" , "categoryId" , categoryId));
  Sort  sortByAndOrder = sortOrder.equalsIgnoreCase("asc") ? Sort.by(sortBy).ascending() : Sort.by(sortBy).descending();
  Pageable pageDetails = PageRequest.of(pageNumber , pageSize , sortByAndOrder);
